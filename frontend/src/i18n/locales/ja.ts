export default {
  ...
  fileManager: {
    ...
    searchFiles: 'ファイルを検索...',
    searchEverything: 'フォルダーとファイルを検索...',
    jumpToFolder: 'フォルダーへ移動...',
    scopeEverywhere: 'すべて',
    scopeThisFolder: 'このフォルダー',
    matchesSummary: 'フォルダー {{folders}} 件 · ファイル {{files}} 件',
    filteredBySearch: '検索で絞り込み中',
    clearSearch: '検索をクリア',
    noMatchingFolders: '一致するフォルダーはありません',
    noSearchResults: '「{{query}}」の結果はありません',
    noSearchResultsDescription: 'このフォルダー内に一致するものはありません。範囲を「すべて」に切り替えるとライブラリ全体を検索できます。',
    allTypes: 'すべての種類',
    prints: '印刷回数',
    ascending: '昇順',
    descending: '降順',
