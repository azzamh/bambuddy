export default {
  ...
  settings: {
    ...
    estimatedFromModel: '估算（打印机型号 × 时长）',
    energyModeEstimatedDescription: '有智能插座数据时使用实测值，其余按打印机型号 × 打印时长估算',
    printerPower: '各打印机型号的平均功率',
    printerPowerHelp: '整个打印过程的平均功率，不是峰值。留空则使用内置估算值。',
    printerPowerNoPrinters: '请先添加打印机，然后设置其功率。',
    fileManager: '文件管理器',
  ...
  fileManager: {
    ...
    searchFiles: '搜索文件...',
    searchEverything: '搜索文件夹和文件...',
    jumpToFolder: '跳转到文件夹...',
    scopeEverywhere: '全部',
    scopeThisFolder: '当前文件夹',
    matchesSummary: '{{folders}} 个文件夹 · {{files}} 个文件',
    filteredBySearch: '已按搜索筛选',
    clearSearch: '清除搜索',
    noMatchingFolders: '没有匹配的文件夹',
    noSearchResults: '没有与“{{query}}”匹配的结果',
    noSearchResultsDescription: '当前文件夹内没有匹配项。将范围切换为“全部”可搜索整个文件库。',
    allTypes: '所有类型',
    prints: '打印',
    ascending: '升序',
    descending: '降序',
