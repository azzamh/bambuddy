export default {
  ...
  settings: {
    ...
    estimatedFromModel: '估算（印表機型號 × 時長）',
    energyModeEstimatedDescription: '有智慧插座數據時使用實測值，其餘依印表機型號 × 列印時長估算',
    printerPower: '各印表機型號的平均功率',
    printerPowerHelp: '整個列印過程的平均功率，不是峰值。留空則使用內建估算值。',
    printerPowerNoPrinters: '請先新增印表機，才能設定其功率。',
    fileManager: '檔案管理器',
  ...
  fileManager: {
    ...
    searchFiles: '搜尋檔案...',
    searchEverything: '搜尋資料夾和檔案...',
    jumpToFolder: '跳至資料夾...',
    scopeEverywhere: '全部',
    scopeThisFolder: '目前資料夾',
    matchesSummary: '{{folders}} 個資料夾 · {{files}} 個檔案',
    filteredBySearch: '已依搜尋篩選',
    clearSearch: '清除搜尋',
    noMatchingFolders: '沒有符合的資料夾',
    noSearchResults: '找不到與「{{query}}」相符的結果',
    noSearchResultsDescription: '目前資料夾內沒有符合的項目。將範圍切換為「全部」可搜尋整個庫。',
    allTypes: '所有類型',
    prints: '列印',
    ascending: '升序',
    descending: '降序',
