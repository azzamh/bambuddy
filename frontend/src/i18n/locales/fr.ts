export default {
  ...
  settings: {
    ...
    estimatedFromModel: 'Estimé (modèle × durée)',
    energyModeEstimatedDescription: 'Utilise les mesures des prises connectées quand elles existent, et estime le reste à partir du modèle × durée d\'impression',
    printerPower: 'Puissance moyenne par modèle d\'imprimante',
    printerPowerHelp: 'Moyenne sur toute l\'impression, pas la pointe. Laissez vide pour utiliser l\'estimation intégrée.',
    printerPowerNoPrinters: 'Ajoutez d\'abord une imprimante pour définir sa puissance.',
  ...
  fileManager: {
    ...
    searchEverything: 'Rechercher dossiers et fichiers...',
    jumpToFolder: 'Aller au dossier...',
    scopeEverywhere: 'Partout',
    scopeThisFolder: 'Ce dossier',
    matchesSummary: '{{folders}} dossiers · {{files}} fichiers',
    filteredBySearch: 'Filtré par la recherche',
    clearSearch: 'Effacer la recherche',
    noMatchingFolders: 'Aucun dossier correspondant',
    noSearchResults: 'Aucun résultat pour « {{query}} »',
    noSearchResultsDescription: 'Rien ne correspond dans ce dossier. Choisissez Partout pour chercher dans toute la bibliothèque.',
    allTypes: 'Tous types',
    prints: 'Impressions',
    ascending: 'Croissant',
    descending: 'Décroissant',
