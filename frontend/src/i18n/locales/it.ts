export default {
  ...
  settings: {
    ...
    estimatedFromModel: 'Stimato (modello × durata)',
    energyModeEstimatedDescription: 'Usa le letture delle prese smart dove ci sono e stima il resto da modello stampante × durata di stampa',
    printerPower: 'Potenza media per modello di stampante',
    printerPowerHelp: 'Media sull\'intera stampa, non il picco. Lascia vuoto per usare la stima integrata.',
    printerPowerNoPrinters: 'Aggiungi prima una stampante per impostarne la potenza.',
  ...
  fileManager: {
    ...
    searchEverything: 'Cerca cartelle e file...',
    jumpToFolder: 'Vai alla cartella...',
    scopeEverywhere: 'Ovunque',
    scopeThisFolder: 'Questa cartella',
    matchesSummary: '{{folders}} cartelle · {{files}} file',
    filteredBySearch: 'Filtrato dalla ricerca',
    clearSearch: 'Cancella ricerca',
    noMatchingFolders: 'Nessuna cartella corrispondente',
    noSearchResults: 'Nessun risultato per “{{query}}”',
    noSearchResultsDescription: 'Niente corrisponde in questa cartella. Passa a Ovunque per cercare in tutta la libreria.',
