export default {
  ...
  fileManager: {
    ...
    searchEverything: 'Search folders and files...',
    jumpToFolder: 'Jump to folder...',
    scopeEverywhere: 'Everywhere',
    scopeThisFolder: 'This folder',
    matchesSummary: '{{folders}} folders · {{files}} files',
    filteredBySearch: 'Filtered by search',
    clearSearch: 'Clear search',
    noMatchingFolders: 'No matching folders',
    noSearchResults: 'No results for “{{query}}”',
    noSearchResultsDescription: 'Nothing in this folder matches. Switch the scope to Everywhere to search the whole library.',
    allTypes: 'All types',
    prints: 'Prints',
    ascending: 'Ascending',
    descending: 'Descending',
  ...
  multiPrintTemplates: {
    ...
    fieldLabel: "Nama",
    fieldLabelPlaceholder: "Template name",
  },
};
