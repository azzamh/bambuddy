export default {
  ...
  nav: {
    ...
    archives: 'Arquivos',
    queue: 'Fila',
    multiPrintTemplates: 'Multi-Item Print Scheduling',
    stats: 'Estatísticas',
    profiles: 'Perfis',
  ...
  settings: {
    ...
    estimatedFromModel: 'Estimado (modelo × tempo)',
    energyModeEstimatedDescription: 'Usa as leituras das tomadas inteligentes quando existem e estima o restante por modelo da impressora × duração da impressão',
    printerPower: 'Potência média por modelo de impressora',
    printerPowerHelp: 'Média ao longo de toda a impressão, não o pico. Deixe em branco para usar a estimativa embutida.',
    printerPowerNoPrinters: 'Adicione uma impressora primeiro para definir a potência dela.',
  ...
  fileManager: {
    ...
    searchEverything: 'Pesquisar pastas e arquivos...',
    jumpToFolder: 'Ir para a pasta...',
    scopeEverywhere: 'Em tudo',
    scopeThisFolder: 'Esta pasta',
    matchesSummary: '{{folders}} pastas · {{files}} arquivos',
    filteredBySearch: 'Filtrado pela pesquisa',
    clearSearch: 'Limpar pesquisa',
    noMatchingFolders: 'Nenhuma pasta correspondente',
    noSearchResults: 'Nenhum resultado para “{{query}}”',
    noSearchResultsDescription: 'Nada corresponde nesta pasta. Mude o escopo para Em tudo para pesquisar toda a biblioteca.',
  ...
  multiPrintTemplates: {
    title: 'Multi-Item Print Scheduling',
    subtitle: 'Manage reusable queue templates',
    listTitle: 'Templates',
    ...
    run: 'Run',
    delete: 'Delete',
    itemsCount: '{{count}} queue items',
    itemsTitle: 'Queue items',
    addItem: 'Add queue item',
    editItem: 'Edit queue item',
    removeItem: 'Remove item',
    itemRequired: 'Add at least one queue item',
    itemModalSubtitle: 'Configure this queue item like the Schedule Print modal',
    createMultipleQueues: 'Create one item per selected printer',
    noDescription: 'No description provided',
    itemLabel: 'Item {{index}}',
    sourceArchive: 'Archive #{{id}}',
    sourceLibrary: 'Library file #{{id}}',
    targetPrinter: 'Printer #{{id}}',
    targetModel: 'Any {{model}} printer',
    nameLabel: 'Template name',
    descriptionLabel: 'Description',
    deleteConfirmTitle: 'Delete Template',
    deleteConfirmMessage: 'Delete "{{name}}"? This action cannot be undone.',
    runConfirmTitle: 'Run Template',
    runConfirmMessage: 'Run "{{name}}" and create queue items?',
    noEditPermission: 'You do not have permission to edit templates',
    noDeletePermission: 'You do not have permission to delete templates',
    noRunPermission: 'You do not have permission to run templates',
    validation: {
      nameRequired: 'Template name is required',
      itemRequired: 'At least one queue item is required',
      sourceRequired: 'Item {{index}}: choose either archive or library file',
      printerTargetConflict: 'Item {{index}}: choose either printer or target model',
      plateInvalid: 'Item {{index}}: plate ID must be 1 or higher',
      amsInvalid: 'Item {{index}}: AMS mapping must be comma-separated numbers',
      printerRequired: 'Select at least one printer',
      targetModelRequired: 'Select a target printer model',
    },
    toast: {
      deleted: 'Template deleted',
      deleteFailed: 'Failed to delete template',
      runSuccess: 'Queued {{count}} item(s)',
      runPartial: '{{count}} item(s) failed',
