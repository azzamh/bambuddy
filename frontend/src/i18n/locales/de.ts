export default {
  ...
  fileManager: {
    ...
    searchEverything: 'Ordner und Dateien durchsuchen...',
    jumpToFolder: 'Zu Ordner springen...',
    scopeEverywhere: 'Überall',
    scopeThisFolder: 'Dieser Ordner',
    matchesSummary: '{{folders}} Ordner · {{files}} Dateien',
    filteredBySearch: 'Nach Suche gefiltert',
    clearSearch: 'Suche löschen',
    noMatchingFolders: 'Keine passenden Ordner',
    noSearchResults: 'Keine Ergebnisse für „{{query}}“',
    noSearchResultsDescription: 'In diesem Ordner passt nichts. Wechsle den Bereich auf Überall, um die ganze Bibliothek zu durchsuchen.',
    allTypes: 'Alle Typen',
    prints: 'Drucke',
    ascending: 'Aufsteigend',
    descending: 'Absteigend',
